...
parser.add_argument("--task", default="gfp", type=str)
parser.add_argument("--num_sampled_per_round", default=128, type=int)
parser.add_argument("--vocab_size", default=20)
parser.add_argument("--max_len", default=237)
parser.add_argument("--gen_max_len", default=237)
...
parser.add_argument("--gen_reward_exp_ramping", default=0, type=float)
